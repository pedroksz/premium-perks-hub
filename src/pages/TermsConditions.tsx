          ...
          <div className="max-w-4xl mx-auto bg-card rounded-2xl shadow-xl p-8 md:p-12 -mt-8 relative">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="warning-box mb-6">
                ...
                <p className="text-muted-foreground text-sm">A Benefícios AMX presta exclusivamente assessoria consultiva e orientação educacional. NÃO somos banco, financeira ou entidade regulada.</p>
              </div>
